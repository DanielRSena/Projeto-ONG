<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $sql_insert_avaliacao = "INSERT INTO avaliações (cpf_assistido, cpf_psico, data_inicio_avaliacao, data_teste) VALUES (:cpf_assistido, :cpf_psicopedagogo, :data_inicio_avaliacao, :data_teste)";
        ...
        try {
            ...
            $id_avaliacao = $pdo->lastInsertId(); // Recuperar o ID gerado da avaliação
            ...
            $sql_insert_respostas = "INSERT INTO testes_questoes (id_avaliacao, id_questao, resposta) VALUES (:id_avaliacao, :id_questao, :resposta)";
