...
<main>
    <div class="dados">
        ...
        <form action="../cadastro/processar_cadastro_assistido.php" method="POST" enctype="multipart/form-data">
            ...
            <input type="date" id="data-nascimento-paciente" name="data-nascimento-paciente">
            ...
            <input type="file" id="foto-paciente" name="foto-paciente">
            <hr>
            <label for="cpfResponsavel-paciente">CPF do responsável:</label>
            <input type="text" id="cpfResponsavel-paciente" name="cpfResponsavel-paciente">
