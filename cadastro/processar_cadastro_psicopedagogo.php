    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (!empty($fotoNome)) {
            ...
            if (move_uploaded_file($fotoTmp, $fotoNomeFinal)) {
                ...
                $sql = "INSERT INTO psicopedagogos (nome, cpf, num_registro, foto) VALUES (:nome, :cpf, :crp, :foto)";
            ...
            else die("Erro ao mover o arquivo para o diretório permanente.");
            
        } 
        else die("Por favor, selecione uma imagem para upload.");
